...
export const GIG_JOBS: GigJob[] = [
  {
    id: "gig_fitness_thumbnail",
    title: "홈트 유튜브 채널 운동 시범 촬영",
    client: "채널 '오늘도근력'",
    stat: "fitness",
    reqStat: 100,
    workload: 90,
    ...
    reputation: 3,
    penalty: 14000,
    desc: "구독자용 홈트 영상에 동작 시범만 보여주시면 돼요. 카메라 앞에서 자세만 정확하면 충분합니다.",
  },
  {
    id: "gig_blog_review",
  ...
  {
    id: "gig_fitness_challenge",
    title: "다이어트 챌린지 프로그램 모델",
    client: "헬스케어앱 '오늘의체지방'",
    stat: "fitness",
    reqStat: 230,
    workload: 100,
    ...
    reputation: 4,
    penalty: 22000,
    desc: "4주 챌린지 전후 몸 변화를 인증샷으로 남겨주시는 체험단 모델입니다. 꾸준함이 생명이에요.",
  },
  {
  ...
  {
    id: "gig_beauty_bridal",
    title: "뷰티 브랜드 룩북 헤어메이크업",
    client: "코스메틱 브랜드 '피부요정'",
    stat: "beauty",
    reqStat: 340,
    workload: 110,
    deadlineDays: 6,
    ...
    reputation: 5,
    penalty: 34000,
    desc: "신상 화장품 룩북 촬영용 헤어·메이크업 담당자를 찾습니다. 컨셉 시안에 맞춰 스타일링만 해주시면 돼요.",
  },
  {
  ...
  {
    id: "gig_fitness_seminar",
    title: "기업 사내 운동 세미나 강사",
    client: "(주)헬시워크",
    stat: "fitness",
    reqStat: 400,
    workload: 120,
    ...
    reputation: 6,
    penalty: 45000,
    desc: "직원 건강증진 세미나에서 스트레칭·운동법을 시연·강의해주실 분을 찾습니다. 실습 위주로 진행됩니다.",
  },
  {
