 ...
 * (콘서트·팬사인회·코믹콘·무대인사 등) 참여하기를 누르면 스케줄에 등록된다.
 */
...
const EVENT_TEMPLATES: Record<EventAttribute, EventTemplate[]> = {
  idol: [
    ...
    { title: "팬사인회", text: "이번 앨범 팬사인회 일정 떴다 눈앞에서 최애를... 참여 안 하면 평생 후회 ✨" },
  ...
  actor: [
    ...
    { title: "팬미팅", text: "단독 팬미팅 개최 소식!! 눈 마주칠 절호의 기회, 이건 참여 안 할 수가 없다" },
