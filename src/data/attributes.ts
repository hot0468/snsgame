...
export const ATTRIBUTES: Record<AttributeId, AttributeDef> = {
  ...
  finance: {
    ...
    label: "재테크계",
    emoji: "",
    bio: "존버는 승리한다고 믿는 개미. 리딩방은 안 믿어요",
    relatedSkills: ["knowledge", "vocabulary"],
    adultOnly: false,
  },
  sports: {
    id: "sports",
    label: "스포츠계",
    emoji: "",
    bio: "직관은 못 참지. 우리 팀은 왜 항상 9회말에 우는가",
    relatedSkills: ["fitness", "sociability"],
    adultOnly: false,
  },
  fashion: {
    id: "fashion",
  ...
  travel: {
    ...
    label: "여행계",
    emoji: "",
    bio: "다음 비행기표 노리는 중. 캐리어는 늘 반쯤 싸여 있음",
    relatedSkills: ["sociability", "vocabulary"],
    adultOnly: false,
  },
  adult: {
...
const AFFINITY: Partial<Record<AttributeId, Partial<Record<AttributeId, number>>>> = {
  ...
  finance: { finance: 1, it: 1, info: 1, politics: 1, daily: -1 },
  sports: { sports: 1, fitness: 1, daily: 1, humor: 1, politics: -1 },
  fashion: { fashion: 1, beauty: 1, idol: 1, actor: 1, travel: 1 },
  travel: { travel: 1, food: 1, daily: 1, fashion: 1, beauty: 1 },
