...
/**
 * 트친 리트윗 응원 카톡 — 한 세트가 자연스럽게 이어지는 대화다.
 * opener(상대가 먼저 보내는 말들) → 내 답장(me) → 상대 마무리(them)로 흐른다.
 * 트친은 온라인 맞팔 사이라 존댓말+가벼운 SNS 말투로 통일(집주인 같은 공식 톤과 다르게).
 */
export interface TchinCheerChat {
  opener: string[];
  reply: { me: string; them: string; label: string };
}

export const TCHIN_CHEER_CHATS: TchinCheerChat[] = [
  {
    opener: [
      "님 방금 글 너무 좋아서 리트윗했어요! 더 많은 사람이 봐야 함 ㅎㅎ",
      "요즘 타임라인에서 님 글이 제일 재밌어요 ㅋㅋ",
    ],
    reply: {
      me: "헐 감사해요ㅠㅠ 이런 말 들으면 진짜 힘나요 🥹",
      them: "당연한 걸요! 다음 글도 알림 켜두고 기다릴게요 🔔",
      label: "고마워요!",
    },
  },
  {
    opener: [
      "이 글은 제 타임라인에 박제합니다 😎",
      "우리 트친인 거 요즘 좀 자랑스럽다니까요 ㅋㅋ",
    ],
    reply: {
      me: "ㅋㅋㅋ 부끄럽게 왜 그래요~ 저도 님 글 항상 잘 보고 있어요",
      them: "오 그래요? 그럼 우리 서로 홍보대사 하는 걸로 🤝",
      label: "고마워요~",
    },
  },
  {
    opener: [
      ...
      "덕분에 제 팔로워들도 님 계정 구경 갔을걸요 ㅎㅎ",
    ],
    reply: {
      me: "우와 진짜요? 덕분에 유입 좀 늘었나 봐요, 고마워요!",
      them: "거봐요 ㅋㅋ 앞으로도 좋은 거 보이면 바로 알티할게요",
      label: "고마워요!",
    },
  },
];
