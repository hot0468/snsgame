...
export function createInitialState(): GameState {
  ...
  return {
    ...
    momoOfferedDay: -1,
    chilnamAlly: false,
    chilnamOffered: false,
    pendingProphecy: false,
    pendingProphecyText: null,
    niglShifts: 0,
    loan: null,
    loanOffered: false,
    unpaidRentStreak: 0,
    ...
    affair: null,
    pendingDecay: null,
    popularity: { lastMonth: -1, rank: null, prevRank: null, followers: 0, best: null },
    pendingPopularity: false,
    authorRank: null,
    pendingAuthorRank: false,
    yearStat: undefined,
    awardsHeld: {},
    pendingAwards: null,
    yearOpenFollowers: 0,
